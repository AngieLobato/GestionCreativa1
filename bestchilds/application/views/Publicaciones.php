...
<html>
	<head>
	    ...
	    <title>Best Childs Magazine</title>
	    <link href="<?=base_url();?>css/bootstrap.min.css" rel="stylesheet" /> 
        <script src="<?=base_url();?>js/jquery.min.js" type="text/javascript"></script>         
        <script src="<?=base_url();?>js/bootstrap.min.js" type="text/javascript"></script>  
        <script type="text/javascript" src="<?=base_url();?>js/modernizr.2.5.3.min.js"></script>
        <script type="text/javascript" src="<?=base_url();?>js/hash.js"></script>
         <script src="<?=base_url();?>js/app.js" type="text/javascript"></script>
	</head>
	<body>
		<div class="container" >
      <input type="hidden" id="page" value="pub"  />  
			<div class="row" >
				<div class="col-md-12">
					<h1 class='text-center'>Best Childss Magazine Publicaciones</h1>				
				</div>                       
			</div>
      <div class="row" >
        <div class="col-md-12">        
           <div id="canvas">
            ...
            yepnope({
              ...
              both: ['<?=base_url();?>js/zoom.min.js', '<?=base_url();?>js/magazine.js', '<?=base_url();?>css/magazine.css'],
              complete: loadApp
            });
